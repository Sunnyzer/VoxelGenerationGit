...
public class OldOldChunkManager : MonoBehaviour
{
    static private OldOldChunkManager instance = null;
    static public OldOldChunkManager Instance => instance;
	...
	[SerializeField] OldOldChunk chunkPrefab = null;
	List<OldOldChunk> chunks = new List<OldOldChunk>();
    ...
    public OldOldChunk GetChunk(int x,int z)
    {
    ...
    private IEnumerator Start()
    {
        ...
        for (int i = 0; i < chunksAmountX; i++)
        {
            ...
            {
                OldOldChunk myChunk = Instantiate<OldOldChunk>(chunkPrefab, new Vector3(i * chunkSize, 0, j * chunkSize), Quaternion.identity, transform);
